...
public class MinecartRevolutionException extends GameException {
    ...
    public MinecartRevolutionException(MinecartRevolution minecartRevolution, String message) {

        super(minecartRevolution.getPlugin(), message);
        this.minecartRevolution = minecartRevolution;
    }

    public MinecartRevolutionException(MinecartRevolution minecartRevolution, Throwable cause, String message) {

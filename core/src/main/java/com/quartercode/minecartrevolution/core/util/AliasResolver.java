...
// We need an extra class here because OddItem is an optional dependency -> class might not be available
public class AliasResolver {

    public static ItemData resolve(String alias) {

        return new ItemData(OddItem.getItemStack(alias));
    }

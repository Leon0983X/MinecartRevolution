...
public class ExpressionSign extends ControlSign {
    ...
    public ControlSignInfo getInfo() {
        ...
        return new ControlSignInfo(Lang.getValue("basiccontrols.signs.expression.name"), Lang.getValue("basiccontrols.signs.expression.description"), "expression.place", "expression.destroy", "control", "script", "expression", "Expression");
    }

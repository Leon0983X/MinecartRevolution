...
public class TimeSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.time.name"), MinecartRevolution.getLang().get("basiccontrols.signs.time.description"), "time.place", "time.destroy", "time");
    }

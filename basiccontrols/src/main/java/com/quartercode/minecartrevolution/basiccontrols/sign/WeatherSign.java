...
public class WeatherSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.weather.name"), MinecartRevolution.getLang().get("basiccontrols.signs.weather.description"), "weather.place", "weather.destroy", "weather");
    }

...
public class LockSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.lock.name"), MinecartRevolution.getLang().get("basiccontrols.signs.lock.description"), "lock.place", "lock.destroy", "lock");
    }

...
public class ClearSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.clear.name"), MinecartRevolution.getLang().get("basiccontrols.signs.clear.description"), "clear.place", "clear.destroy", "clear");
    }

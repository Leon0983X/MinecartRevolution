...
public class SpeedSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.speed.name"), MinecartRevolution.getLang().get("basiccontrols.signs.speed.description"), "speed.place", "speed.destroy", "speed");
    }

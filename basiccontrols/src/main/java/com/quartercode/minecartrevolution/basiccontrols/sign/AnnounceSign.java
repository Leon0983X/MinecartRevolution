...
public class AnnounceSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.announce.name"), MinecartRevolution.getLang().get("basiccontrols.signs.announce.description"), "announce.place", "announce.destroy", "announce");
    }

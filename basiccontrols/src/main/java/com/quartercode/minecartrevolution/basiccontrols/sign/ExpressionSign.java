...
public class ExpressionSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.expression.name"), MinecartRevolution.getLang().get("basiccontrols.signs.expression.description"), "expression.place", "expression.destroy", "revo", "control", "script", "expression");
    }
    ...
    public void execute(Minecart minecart, String label, Sign sign) {
        ...
        String expression = ExpressionExecutor.getExpression(lines);

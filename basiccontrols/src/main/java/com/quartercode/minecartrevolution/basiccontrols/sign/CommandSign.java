...
public class CommandSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.command.name"), MinecartRevolution.getLang().get("basiccontrols.signs.command.description"), "command.place", "command.destroy", "command");
    }

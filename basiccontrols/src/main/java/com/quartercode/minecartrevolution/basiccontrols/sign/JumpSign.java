...
public class JumpSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.jump.name"), MinecartRevolution.getLang().get("basiccontrols.signs.jump.description"), "jump.place", "jump.destroy", "jump", "vertical");
    }

...
public class GrabSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.grab.name"), MinecartRevolution.getLang().get("basiccontrols.signs.grab.description"), "grab.place", "grab.destroy", "grab");
    }

...
public class CollectSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.collect.name"), MinecartRevolution.getLang().get("basiccontrols.signs.collect.description"), "collect.place", "collect.destroy", "collect");
    }

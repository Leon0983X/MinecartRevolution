...
public class ReverseBlock extends ControlBlock {
    ...
    protected ControlBlockInfo createInfo() {
        ...
        return new ControlBlockInfo(MinecartRevolution.getLang().get("basiccontrols.blocks.reverse.name"), MinecartRevolution.getLang().get("basiccontrols.blocks.reverse.description"), "reverse.place", "reverse.destroy", new ItemData(Material.WOOL));
    }

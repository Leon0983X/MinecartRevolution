...
public class FileSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.file.name"), MinecartRevolution.getLang().get("basiccontrols.signs.file.description"), "file.place", "file.destroy", "file");
    }

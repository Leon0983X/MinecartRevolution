...
public class HoldSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.hold.name"), MinecartRevolution.getLang().get("basiccontrols.signs.hold.description"), "hold.place", "hold.destroy", "hold");
    }

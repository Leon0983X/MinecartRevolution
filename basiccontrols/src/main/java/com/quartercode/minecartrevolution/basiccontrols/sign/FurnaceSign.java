...
public class FurnaceSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.furnace.name"), MinecartRevolution.getLang().get("basiccontrols.signs.furnace.description"), "furnace.place", "furnace.destroy", "furnace", "smelt");
    }

...
public class BrakeBlock extends ControlBlock {
    ...
    protected ControlBlockInfo createInfo() {
        ...
        return new ControlBlockInfo(MinecartRevolution.getLang().get("basiccontrols.blocks.brake.name"), MinecartRevolution.getLang().get("basiccontrols.blocks.brake.description"), "brake.place", "brake.destroy", new ItemData(Material.SOUL_SAND));
    }

...
public class EjectSign extends ControlSign {
    ...
    protected ControlSignInfo createInfo() {
        ...
        return new ControlSignInfo(MinecartRevolution.getLang().get("basiccontrols.signs.eject.name"), MinecartRevolution.getLang().get("basiccontrols.signs.eject.description"), "eject.place", "eject.destroy", "eject");
    }

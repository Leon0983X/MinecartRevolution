...
public class CommandMinecartTerm implements MinecartTerm {

    public CommandMinecartTerm() {
    ...
    public String[] getLabels() {
        ...
        return new String[] { "com", "command" };
    }

    @Override
    public boolean getResult(Minecart minecart, Direction direction, String term) {

        return MinecartType.valueOf(minecart) == MinecartType.COMMAND;
    }

...
public class RideableMinecartTerm implements MinecartTerm {

    public RideableMinecartTerm() {
    ...
    public String[] getLabels() {
        ...
        return new String[] { "m", "minecart", "rideable", "standard", "default" };
    }

    @Override
    public boolean getResult(Minecart minecart, Direction direction, String term) {

        return MinecartType.valueOf(minecart) == MinecartType.RIDEABLE;
    }
